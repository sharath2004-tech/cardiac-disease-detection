...
class ACRMFConfig:
    ...
    # PROJECT PATHS
    # ============================================================================
    project_root: Path = Path(__file__).parent.parent  # ACRMF_Net_Model/
    parent_root: Path = Path(__file__).parent.parent.parent  # cardiac-disease-detection/
    data_dir: Path = field(default_factory=lambda: Path(__file__).parent.parent.parent / "datasets")
    ...
    # Dataset paths (shared with CardioM3Net - in parent directory)
    ptb_xl_dir: Path = field(default_factory=lambda: Path(__file__).parent.parent.parent / "ptb-xl-a-large-publicly-available-electrocardiography-dataset-1.0.3")
    pcg_archive_dir: Path = field(default_factory=lambda: Path(__file__).parent.parent.parent / "archive")
    clinical_csv: Path = field(default_factory=lambda: Path(__file__).parent.parent.parent / "heart_disease_uci.csv")
